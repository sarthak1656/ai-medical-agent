    ...
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Your AI medical voice assistant, always listening"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        >
          Talk naturally with our AI-powered medical voice agent. It assists
          patients, captures symptoms, schedules appointments, and supports
          healthcare teams in real time — securely and reliably.
        </motion.p>
...
const Navbar = () => {
  const { user } = useUser();
  return (
    <nav className="flex w-full items-c enter justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
